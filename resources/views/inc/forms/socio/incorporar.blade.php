<form id="{{ $id }}" class="border border-light p-5" method="{{ $metodo }}" action="{{ route($action) }}">
    ...
    <!-- # socio -->
    <x-input label="N° Socio" tipo="text" nombre="numero" id="numero" margen="mb-4" tamano="form-control-sm" :valor="ultimoNumeroSocio()" placeholder="Ej. 123" obligatorio="si"/>    
    ...
    <!-- Fecha pucv -->
    <x-input label="Fecha PUCV" tipo="text" nombre="fecha_pucv" id="fecha_pucv" margen="mb-4" tamano="form-control-sm" valor="" placeholder="Ej. 01-01-2020" obligatorio="no"/> 
