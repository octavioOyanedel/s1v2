...
function obtenerEnlacesMantenedor($ruta)
{
	...
	if($ruta === 'home' || $ruta === 'socios/create' || preg_match('/^socios\/([0-9]*)\/edit/', $ruta) || preg_match('/^socios\/([0-9]*)/', $ruta) || $ruta === 'form_filtro_socios' || $ruta === 'buscar' || strpos($ruta, 'filtrar_socios') !== FALSE){
